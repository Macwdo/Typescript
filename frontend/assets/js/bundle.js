...
/***/ "./src/webpack/exercicio/form-validate-o.ts":
/*!**************************************************!*\
  !*** ./src/webpack/exercicio/form-validate-o.ts ***!
  \**************************************************/
...
function checkForEmptyFields(...inputs) {
    inputs.forEach((input) => {
        if (!input.value)
            showErrorMessage(input, "Esse campo nao pode estar vazio");
    });
}
...
__webpack_require__(/*! ./form-validate-o */ "./src/webpack/exercicio/form-validate-o.ts");
// Campo vazio
// Email correto
// Duas senhas Batem
